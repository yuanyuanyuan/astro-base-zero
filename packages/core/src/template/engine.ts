...
export class TemplateEngine {
  ...
  private registerBuiltinHelpers(): void {
    ...
    this.handlebars.registerHelper('camelCase', (str: string) => {
      return str ? str.replace(/[-_\s]+(.)?/g, (_, char) => char ? char.toUpperCase() : '') : '';
    });

    this.handlebars.registerHelper('pascalCase', (str: string) => {
      const camelCase = str ? str.replace(/[-_\s]+(.)?/g, (_, char) => char ? char.toUpperCase() : '') : '';
    ...
    this.handlebars.registerHelper('ifContains', function(this: any, array: any[], item: any, options: any) {
    ...
    this.handlebars.registerHelper('ifEmpty', function(this: any, value: any, options: any) {
      const isEmpty = !value || 
    ...
    // 日期处理 Helper
    this.handlebars.registerHelper('formatDate', (date: string | Date, format = 'YYYY-MM-DD') => {
    ...
    this.handlebars.registerHelper('absoluteUrl', (path: string, baseUrl: string) => {
